...
For the detailed verification model, admin A/B gates, and research validation, see [Self-Improvement & Research Validation](/docs/architecture/self-improvement-research-validation).
...
- [Self-Improvement & Research Validation](/docs/architecture/self-improvement-research-validation) - private skills, A/B tests, and benchmark strategy
